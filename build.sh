...
VERSION="${BA_CLICK_VERSION:-0.3.2}"
...
tell application "Finder"
	tell disk "$VOLNAME"
		...
		set position of item "BA Click.app" of container window to {170, 120}
		set position of item "Applications" of container window to {470, 120}
		close
		open
		update
	end tell
